...
def csv_gps_road_time(
    ...
    # 시간 범위 리스트
    time_range_dict = get_time_ranges(
    ...
    #         [coord[1], coord[0]] for coord in road_rec_coordinate["coordinates"]
    #     ]
    # except KeyError:
    #     change_pos_rectangle = [[coord[1], coord[0]] for coord in road_rec_coordinate]
        ...
        for display_id in day_dict.keys():
            ...
            try:
                ...
                filter_data_by_time_range(
                    csv_data.copy(), time_diff_dict, time_series_dict
                )
